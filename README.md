...
- `ee pack list|inspect|draft create|review|publish|compile|rollback` for the local Experience Pack workflow and host instruction exports (`AGENTS.md`, `CODEX.md`, GitHub agent profile markdown)
