...
CREATE TABLE IF NOT EXISTS experience_packs (
  ...
  host_compatibility_json TEXT NOT NULL,
  created_at TEXT NOT NULL,
  updated_at TEXT NOT NULL,
  published_at TEXT,
  rolled_back_at TEXT
...
CREATE TABLE IF NOT EXISTS experience_pack_versions (
...
CREATE TABLE IF NOT EXISTS experience_pack_memberships (
  pack_id TEXT NOT NULL,
  version TEXT NOT NULL,
  node_id TEXT NOT NULL,
  created_at TEXT NOT NULL,
  PRIMARY KEY (pack_id, version, node_id)
);

CREATE TABLE IF NOT EXISTS experience_pack_activations (
  scope_id TEXT NOT NULL,
  pack_id TEXT NOT NULL,
