...
export const RUNTIME_INSTALL_ATTESTATION_SCHEMA_VERSION = "runtime-install-attestation-v1" as const;

export const MACHINE_INTEGRITY_KEY_RELATIVE_PATH = "machine-secrets/integrity-key.json" as const;
export const RUNTIME_INSTALL_ATTESTATION_DIRECTORY_RELATIVE_PATH =
  "runtime-install/attestations" as const;
