...
export const RUNTIME_CLOSURE_REQUIRED_RUNTIME_FILES: Array<Omit<RuntimeClosureAsset, "sha256">> = [
  ...
  { role: "runtime_activation_constants", path: "dist/runtime/activation/constants.js" },
  { role: "runtime_activation_types", path: "dist/runtime/activation/types.js" },
  { role: "runtime_activation_errors", path: "dist/runtime/activation/errors.js" },
  { role: "runtime_activation_database", path: "dist/runtime/activation/database.js" },
  { role: "runtime_activation_state_contract", path: "dist/runtime/activation/state-contract.js" },
  { role: "runtime_activation_repository", path: "dist/runtime/activation/repository.js" },
  { role: "runtime_activation_control", path: "dist/runtime/activation/control.js" },
  { role: "runtime_activation_transitions", path: "dist/runtime/activation/transitions.js" },
  { role: "runtime_activation_handshake", path: "dist/runtime/activation/handshake.js" },
  { role: "runtime_activation_orchestrator", path: "dist/runtime/activation/orchestrator.js" },
  { role: "runtime_configuration_route_authority_adapter", path: "dist/runtime/activation/configuration-route-authority.js" },
  { role: "runtime_activation_authority", path: "dist/runtime/activation/authority.js" },
  { role: "runtime_configuration_activation_invalidation", path: "dist/runtime/activation/configuration-invalidation.js" },
  { role: "runtime_activation_status", path: "dist/runtime/activation/status.js" },
  { role: "runtime_cli_authority_inspection", path: "dist/runtime/activation/cli-inspection.js" },
  { role: "runtime_process_start_identity", path: "dist/runtime/activation/process-identity.js" },
  { role: "runtime_supervisor_launcher", path: "dist/runtime/activation/supervisor-launcher.js" },
  { role: "runtime_worker_launcher", path: "dist/runtime/activation/worker-launcher.js" },
  { role: "runtime_package_local_service_controller", path: "dist/runtime/activation/service-controller.js" },
  { role: "runtime_native_service", path: "dist/runtime/activation/native-service.js" },
  { role: "runtime_native_control_handlers", path: "dist/runtime/activation/native-control-handlers.js" },
  { role: "runtime_blocked_system_work_control", path: "dist/runtime/activation/queue-control.js" },
  { role: "runtime_production_service", path: "dist/runtime/activation/production-service.js" },
  { role: "runtime_activation_expiry_coordinator", path: "dist/runtime/activation/expiry-coordinator.js" },
