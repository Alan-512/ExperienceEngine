# experience-repo-policy Specification

## Purpose
Define repo-level policy controls that tune diagnostic delivery, circuit breaker behavior, and operator inspection while preserving stronger scope, lifecycle, and delivery-state safety gates.
## Requirements
