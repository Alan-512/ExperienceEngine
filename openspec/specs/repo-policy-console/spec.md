# repo-policy-console Specification

## Purpose
Define operator-readable repo policy inspection surfaces that explain configured mode, effective mode, circuit state, bounded evidence, and restore guidance without changing policy or governance records.
## Requirements
