...
The current diagnostics/public-feedback implementation plan is [`../phase-0.5b-diagnostics-public-feedback-plan-2026-07-16.md`](../phase-0.5b-diagnostics-public-feedback-plan-2026-07-16.md). D1-D2 provide a local-pack-accepted read-only manifest, review directory, and deterministic local archive; the public support workflow remains a later slice.
