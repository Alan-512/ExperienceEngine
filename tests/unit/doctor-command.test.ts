  ...
  it("reports Antigravity user install separately from current project activation", async () => {
      ...
      inspectAntigravityInstall: () =>
        ({
          ...
          globalWiring: {
            ...
            idePluginDir: "C:\\Users\\123\\.gemini\\antigravity-ide\\plugins\\experienceengine",
            idePluginRegistered: false,
            ideHooksRegistered: false,
            ideMcpCacheDir: "C:\\Users\\123\\.gemini\\antigravity-ide\\mcp\\experienceengine",
            ideMcpToolCacheRegistered: true,
            ideActivation: "mcp_cache_observed",
    ...
    expect(consoleTableSpy).toHaveBeenCalledWith([
      expect.objectContaining({
        ...
        ide_mcp_cache_registered: true,
        ide_hooks_registered: false,
        ide_activation: "mcp_cache_observed",
    ...
    expect(consoleLogSpy.mock.calls).toEqual(
      expect.arrayContaining([
        ...
        ["- IDE MCP cache: observed (C:\\Users\\123\\.gemini\\antigravity-ide\\mcp\\experienceengine)"],
        ["- IDE hooks: not observed (C:\\Users\\123\\.gemini\\antigravity-ide\\plugins\\experienceengine)"],
