  ...
  it("reports Antigravity user install separately from current project activation", async () => {
    ...
    expect(consoleTableSpy).toHaveBeenCalledWith([
      expect.objectContaining({
        ...
        ide_hooks_registered: true,
        ide_activation: "hooks_observed",
    ...
    expect(consoleLogSpy.mock.calls).toEqual(
      expect.arrayContaining([
        ...
        ["- IDE hooks: observed (C:\\Users\\123\\.gemini\\config\\plugins\\experienceengine)"],
